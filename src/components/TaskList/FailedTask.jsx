...
const FailedTask = ({data}) => {
  return (
      ...
      <div className='flex-shrink-0 w-[300px] sm:w-72 h-full bg-red-400 p-5 rounded-2xl shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-200'>
